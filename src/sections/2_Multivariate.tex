...
\begin{definitionBox}[Joint cumalitive distribution function (JCDF)]
...
\begin{definitionBox}[Marginal CDF]
...
\begin{definitionBox}[Joint probability mass function (JPMF)]
...
\begin{definitionBox}[Joint probability density function (JPDF)]
...
\begin{definitionBox}[Mutual independence]
...
\begin{definitionBox}[Group independence]
...
\begin{definitionBox}[Independent and identically distributed (i.i.d.) random variables]
...
\begin{definitionBox}[Mutually independent complex random variables]
...
Most of the information from this section is obtained from \cite{gustafsson_nonlinear_2008}.
...
\begin{definitionBox}[Order statistics]
...
\begin{definitionBox}[Mean of a random vector]
...
\begin{definitionBox}[Mean of a random matrix]
    Let 
    \begin{align}
        \mbfrv{X} &= 
...
\begin{definitionBox}[Correlation matrix]
...
\begin{definitionBox}[Mutually orthogonal random variables]
...
\end{definitionBox}
\begin{definitionBox}[Mutually uncorrelated random variables]
...
\begin{definitionBox}[Uncorrelated random vectors]
    ...
    \end{align}
\end{definitionBox}
\begin{definitionBox}[Orthogonal random vectors]
...
\begin{definitionBox}[Moments of random vectors]
...
\begin{definitionBox}[CDF of continuous RV conditioned on discrete RV]
...
\begin{definitionBox}[PMF of discrete RV conditioned a discrete RV] 
...
\begin{definitionBox}[PDF of continuous RV conditioned on continuous RV]
...
\begin{definitionBox}[CDF of continous RV conditioned on continuous RV]
...
\begin{definitionBox}[Multivaraite conditional PDF]
...
\begin{definitionBox}[Multivariate conditional CDF]
...
\begin{definitionBox}[Conditional mean]
