...
From \cite{psaromiligkosSlidesECSE5092019}.
\begin{definitionBox}[Bernoulli drandom variable]
...
From \cite{psaromiligkosSlidesECSE5092019}.
\begin{definitionBox}[Geometric random variable]
...
\begin{definitionBox}[Binomial random variable]
...
\begin{definitionBox}[Uniform random variable]
...
\begin{definitionBox}[Exponential random variable]
...
\begin{definitionBox}[Gaussian (normal) distribution]
...
\begin{definitionBox}[Standard Normal Distribution]
...
\begin{definitionBox}[Complex Gaussian radnom vector]
...
\begin{definitionBox}[Chi-squared distribution]
