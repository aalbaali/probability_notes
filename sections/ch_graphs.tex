...
\begin{mydefinition}[Directed graphs]
...
\end{mydefinition}
\begin{mydefinition}[Directed acyclic graph]
...
\begin{mydefinition}[Bayesian networks]
...
\begin{mydefinition}[D-donnection and d-separation]
